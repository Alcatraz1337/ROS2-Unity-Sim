...
{
    [Serializable]
    public class PoseWithFitnessMsg : Message
    {
        public const string k_RosMessageName = "pso_q_msgs/PoseWithFitness";
        ...
        public PoseWithFitnessMsg(float pos_x, float pos_y, float pos_z, float rot_x, float rot_y, float rot_z, float rot_w, float fitness)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
        ...
        public static PoseWithFitnessMsg Deserialize(MessageDeserializer deserializer) => new PoseWithFitnessMsg(deserializer);

        private PoseWithFitnessMsg(MessageDeserializer deserializer)
        {
