...
namespace RosMessageTypes.PsoQ
{
    ...
    {
        public const string k_RosMessageName = "pso_q_msgs/Pose";
        ...
        public PoseMsg(float pos_x, float pos_y, float pos_z, float rot_x, float rot_y, float rot_z, float rot_w)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
